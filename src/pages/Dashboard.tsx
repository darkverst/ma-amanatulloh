      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between sticky top-0 z-30">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] sm:text-xs text-gray-500 hidden sm:block">Kelola konten website MA Amanatulloh</p>
          </div>
        </div>
                  ...
                  <div className="rounded-2xl border border-gray-100 bg-white p-4 sm:p-6 shadow-sm">
                    ...
                    <div className="mt-4 grid gap-4 sm:grid-cols-2">
                      <div>
                        ...
                        <input type="text" value={identityForm.schoolName} onChange={(e) => setIdentityForm({ ...identityForm, schoolName: e.target.value })} className={inputCls} placeholder="MA Amanatulloh" />
                      </div>
                      <div>
                        <label className={labelCls}>Nama Singkat Header</label>
                        <input type="text" value={identityForm.schoolShortName} onChange={(e) => setIdentityForm({ ...identityForm, schoolShortName: e.target.value })} className={inputCls} placeholder="MA Amanatulloh" />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <input type="text" value={identityForm.legalName} onChange={(e) => setIdentityForm({ ...identityForm, legalName: e.target.value })} className={inputCls} placeholder="MA Amanatulloh" />
                      </div>
                    </div>
                    <div className="mt-4">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100 space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    ...
                    <input type="text" value={instagramSettingsForm.username} onChange={e => setInstagramSettingsForm({ ...instagramSettingsForm, username: e.target.value })} className={inputCls} placeholder="@ma_amanatulloh" />
                  ...
                  <div>
                    ...
                    <input type="url" value={instagramSettingsForm.profileUrl} onChange={e => setInstagramSettingsForm({ ...instagramSettingsForm, profileUrl: e.target.value })} className={inputCls} placeholder="https://www.instagram.com/ma_amanatulloh" />
                  </div>
                </div>
                <div>
    ...
    <div className="animate-fadeIn space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100 space-y-4">
        ...
        <div className="bg-gray-50 rounded-xl p-3 sm:p-4 border border-gray-100">
          ...
          <div className="bg-white rounded-lg p-3 border border-gray-200">
            ...
            <p className="text-green-700 text-xs truncate mt-0.5">
              {seoForm.canonicalUrl || 'https://ma-amanatulloh.sch.id'}
            </p>
        ...
        <div>
          ...
          <p className="text-[10px] text-gray-400 mt-1">Pisahkan dengan koma. Contoh: MA Amanatulloh, madrasah, pendidikan</p>
        </div>
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100 space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div>
            ...
            <input type="url" value={seoForm.canonicalUrl} onChange={e => setSeoForm({ ...seoForm, canonicalUrl: e.target.value })} className={inputCls} placeholder="https://ma-amanatulloh.sch.id" />
          </div>
        </div>
